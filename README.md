...
<p>El número de diálogos HTML corresponde al número de elementos dentro del areglo de diálogos, por lo tanto el número de diálogos puede ser <strong>"mayor o igual" que CERO</strong>.</p>
